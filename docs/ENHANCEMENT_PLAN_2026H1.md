...
- **Tests:** the current tree contains 287 test functions; optional integrations
...
**Current tree: 287 test functions.** Both benchmarks hold (scripted 15/15 @ 0% ASR; real AgentDojo 97+35 @ 0% ASR / 100% utility under deterministic ground-truth replay).
